...
var Importer = function() {
  ...
  */
  var BackFiller = function (stopIndex, startIndex, callback) {
   ...
   /**
    * getLedger
    * get a specific ledger from casinocoind
   ...
   /**
    * handleLedger
    * process the ledger returned from casinocoind
    */
  ...
  */
  var LiveStream = function () {
    ...
    var latest; //latest ledger from casinocoind
    var first;  //first ledger from casinocoind
    self._active = true;
