...
var Validator = function() {
  ...
  function getLatestIndex() {
    ...
    importer.getLedger(null, function (err, resp) {
      console.log(resp.ledger_index,'------------------resp')
      console.log(parseInt(resp.ledger_index, 10) ,'------------------parseInt(resp.ledger_index, 10) ')
  ...
  function checkNextLedger() {
    console.log(lastValid.ledger_index + 1, '-------------------lastValid.ledger_index + 1')
    hbase.getLedger({
    ...
    function (err, ledger) {
      console.log(ledger,'--------ledger from hbase')
      var hash;
      var converted;
      var message;
      ...
      try {
        hash = casinocoinAPI.computeLedgerHash(convertLedger(ledger));
